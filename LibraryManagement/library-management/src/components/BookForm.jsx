        ...
        <form className="w-full max-w-lg mx-auto mt-5" onSubmit={submitForm}>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <button type='button' onClick={addCategory} className="bg-primary p-1 rounded-lg mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 p-1 text-white">
                ...
                <div className='flex flex-wrap'>
                    {categories.map(c => (
                        <span key={c} className='mx-1 my-1 text-dark rounded-full px-2 py-1 text-sm bg-primary'> {c}</span>
                    ))}
                </div>
            </div>
            
            <button className='text-dark bg-primary px-3 py-2 rounded-2xl flex justify-center items-center gap-1 w-full' type="submit">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>

                <span className="hidden md:block text-white">Submit</span>
            </button>
        </form>
    )
}
