        ...
        <nav className={`border border-b-1 ${isDark ? 'bg-dbg border-primary' : 'bg-white'}`}>
            <ul className='flex justify-between items-center p-3 max-w-6xl mx-auto'>
                <li className='flex items-center gap-3'>
                    ...
                    <input type="text" placeholder='search books...' className='outline-none' value={search} onChange={(e)=>setSearch(e.target.value)}/>
                ...
                <li className='flex gap-3 items-center'>
                    ...
                    {/* profile image */}
                    <div className='w-10'>
                        <img src="https://media.macphun.com/img/uploads/customer/how-to/608/15542038745ca344e267fb80.28757312.jpg?q=85&w=1340" alt="" className='w-full rounded-full' />
                    </div>
                    <div className='cursor-pointer'>
                        {theme==='dark' && <img src={lightIcon} onClick={()=>changeTheme('light')}></img>}
                        {theme==='light' && <img src={darkIcon} onClick={()=>changeTheme('dark')}></img>}
                    </div>
                    ...
                    <div className='space-x-3'>
                        ...
                        {!!user && <button onClick={userLogout} className='bg-red-500 text-white rounded-lg px-2 py-2 text-sm'>Logout</button>}
                    </div>
                </li>
            </ul>
        </nav>
